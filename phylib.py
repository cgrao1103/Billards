...
def countRollingBalls(table):
    return _phylib.countRollingBalls(table)

def copyAndRollBalls(table, resultTable, currentTime):
    return _phylib.copyAndRollBalls(table, resultTable, currentTime)

def checkBallStopped(resultTable):
    return _phylib.checkBallStopped(resultTable)

def checkCollisionAndBounce(resultTable, i, j):
    return _phylib.checkCollisionAndBounce(resultTable, i, j)

def simulateTable(table):
    return _phylib.simulateTable(table)

def handleCushionBounce(a, b):
    return _phylib.handleCushionBounce(a, b)

def handleRollingBallBounce(a, b):
    return _phylib.handleRollingBallBounce(a, b)
